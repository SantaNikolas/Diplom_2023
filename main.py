                            ...
                            if text.lower() == 'начать':
                                ...
                                send_message(user_id=user_id,
                                             message=f"Рад Вас приветствовать, {get_person_info(person_id=user_id)[0]}!"
                                                     f"\n\nЯ чат-бот VKinder  подберу Вам пару."
                                                     f"\n\nЯ только учусь, поэтому мне очень важно, "
                                                     f"чтобы Вы правильно отвечали на мои вопросы."
                                                     f"\n\nВведите 'да', если Вы готовы познакомиться с первым кандидатом.")
                                ...
                                send_message(user_id=user_id,
                                             message=f"Желаете продолжить?  введите 'да'.\n\n"
                                                     f"Если выс все устроило - введите 'нет'.")
